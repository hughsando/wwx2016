...
class Talk extends Sprite
{
   ...
   function createTitle(inTitle,inSize=36.0,?inColour:Null<Int>)
   {
      return createTitleLayout( createTextLayout(inTitle,inSize, inColour));
   }
   ...
   function bulletless(ioLayout:Layout, inText:String,inIndent = 1) : DisplayObject
   {
   ...
   function bullet(ioLayout:Layout, inText:String,inIndent = 1, inSize=24) : DisplayObject
   {
      var textLayout = createTextLayout(inText,inSize);
